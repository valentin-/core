 ...
 * Palettes
 */
$GLOBALS['TL_DCA']['tl_iso_producttype']['palettes']['coupon'] = '{name_legend},name,class,fallback;{description_legend:hide},description;{prices_legend:hide},prices;{template_legend},list_template,reader_template,list_gallery,reader_gallery,cssClass;{attributes_legend},attributes;{variants_legend:hide},variants;{expert_legend:hide},shipping_exempt,downloads;{coupon_legend},coupon_info,coupon_prefix,coupon_numbers,coupon_alphabet,coupon_chars';
